...
const file_proto_mcp_proto_rawDesc = "" +
	...
	"\x06config\x18\x01 \x01(\tR\x06config2B\n" +
	"\n" +
	"MCPService\x124\n" +
	"\rGetCrioConfig\x12\n" +
	".mcp.Empty\x1a\x17.mcp.CrioConfigResponseB-Z+github.com/harche/crio-mcp-server/pkg/protob\x06proto3"
...
var file_proto_mcp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_mcp_proto_depIdxs = []int32{
	...
	1, // 1: mcp.MCPService.GetCrioConfig:output_type -> mcp.CrioConfigResponse
